 ...
 * qualcuno, evitando l'invio ai fake id e a sè stesso; successivamente, ogni volta
 * che riceve un messaggio di OK da un utente, aggiunge questi alla chat; infine
 * aggiunge anche sè stesso.
 */
 ...
 * questa dall'elenco delle chat a cui si è connessi, dopo di che attende che tutti 
...
/*
 * Consente ad un utente di creare una chat purchè abbia un nome che non sia nullo o
