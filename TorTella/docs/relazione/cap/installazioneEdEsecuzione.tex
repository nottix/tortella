...
\begin{enumerate}
\item Posizionarsi nella directory \lstinline{./docs};
\item Eseguire il comando \lstinline{doxygen doxygen.conf}.
\end{enumerate}
La documentazione verrà generata nella directory \lstinline{./docs/documentation} nei formati \textit{latex}, \textit{html} e \textit{manpages}.
